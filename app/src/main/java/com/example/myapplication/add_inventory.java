        ...
        addToList.setOnClickListener(new View.OnClickListener(){
           ...
           @Override
            ...
            if (con == null) {
                ...
                String query = "INSERT INTO" + Refrence.ServerDatabaseInv + "(SKU, ItemName, itemDescrip, itemQuant, UOM, [Cost/Unit], MinToNoti, ReorderPoint) VALUES ('"+str_itemSKU+ "', '"+ str_itemName+ "', '"+str_itemDesc+ "', '"+str_itemQTY+ "', '"+str_itemUOM+"', '"+str_CostpUnit+"', '"+str_MinToNot+"', '"+str_ROP+"')";
